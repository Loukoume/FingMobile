...
import com.credi.fing.publics.service.impl.Composant;
                ...
                case "date":
                    ...
                    inputEditText.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            new com.credi.fing.publics.service.impl.Composant(object,field,"yyyy-MM-dd'T'HH:mm:ss").showDateTimePicker(context,attribut.getName(),inputEditText,"edite"
