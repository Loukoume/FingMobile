...
import com.credi.fings.entity.ClientClassification;
...
public class ClientClassificationBinder implements Serializable, BinderInterface {
    @Override
...
new Attribut("Mandatory","mandatory",true)       
 );
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(ClientClassification.class)
                .setTitle("ClientClassification".toUpperCase())
                .setEndPointSave("client_classification")
                .setDataUrl("client_classification/all")
                .setPostData(new ClientClassification())
                .setAddButton(true)
