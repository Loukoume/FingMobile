...
import com.credi.fings.entity.LegalForm;
...
public class LegalFormBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(LegalForm.class)
                .setTitle("LegalForm".toUpperCase())
                .setEndPointSave("legal_form")
                .setDataUrl("legal_form/all")
                .setPostData(new LegalForm())
                .setAddButton(true)
