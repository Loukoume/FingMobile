...
import com.credi.fings.entity.DepositType;
...
public class DepositTypeBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(DepositType.class)
                .setTitle("DepositType".toUpperCase())
                .setEndPointSave("deposit_type")
                .setDataUrl("deposit_type/all")
                .setPostData(new DepositType())
                .setAddButton(true)
