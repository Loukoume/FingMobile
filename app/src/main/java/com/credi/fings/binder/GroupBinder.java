...
import com.credi.fings.entity.Group;
...
public class GroupBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(Group.class)
                .setTitle("Group".toUpperCase())
                .setEndPointSave("group")
                .setDataUrl("group/all")
                .setPostData(new Group())
                .setAddButton(true)
