...
import com.credi.fings.entity.MainBusinessLine;
...
public class MainBusinessLineBinder implements Serializable, BinderInterface {
    @Override
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(MainBusinessLine.class)
                .setTitle("MainBusinessLine".toUpperCase())
                .setEndPointSave("main_business_line")
                .setDataUrl("main_business_line/all")
                .setPostData(new MainBusinessLine())
                .setAddButton(true)
