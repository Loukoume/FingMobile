...
import com.credi.fings.entity.Constitution;
...
public class ConstitutionBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(Constitution.class)
                .setTitle("Constitution".toUpperCase())
                .setEndPointSave("constitution")
                .setDataUrl("constitution/all")
                .setPostData(new Constitution())
                .setAddButton(true)
