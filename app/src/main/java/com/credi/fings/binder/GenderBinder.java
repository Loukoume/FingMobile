...
import com.credi.fings.entity.Gender;
...
public class GenderBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(Gender.class)
                .setTitle("Gender".toUpperCase())
                .setEndPointSave("gender")
                .setDataUrl("gender/all")
                .setPostData(new Gender())
                .setAddButton(true)
