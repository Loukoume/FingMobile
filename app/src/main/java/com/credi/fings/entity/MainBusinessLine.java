...
public class MainBusinessLine implements Serializable {
    private String idLocal;
    @Expose
    @SerializedName("idMainBusinessLine")
    ...
    public MainBusinessLine fromJs(String js) {
        return new Gson().fromJson(js, MainBusinessLine.class);
    }
}
