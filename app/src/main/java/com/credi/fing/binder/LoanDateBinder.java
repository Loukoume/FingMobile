...
public class LoanDateBinder implements Serializable, BinderInterface {
    @Override
    public Binder binder() {
        Binder binder = new Binder("submittedByUsername", "")
                .setDefaultMenu();
    ...
    public List<Attribut> setAttribut() {
        List<Attribut> attributs = Arrays.asList(
                new Attribut("Submittedondate", "submittedOnDate", true),
                new Attribut("Approvedondate", "approvedOnDate", true),
                new Attribut("Expecteddisbursementdate", "expectedDisbursementDate", true),
                new Attribut("Actualdisbursementdate", "actualDisbursementDate", true),
                new Attribut("Expectedmaturitydate", "expectedMaturityDate", true)
        );
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(LoanDate.class)
                .setTitle("LoanDate".toUpperCase())
                .setEndPointSave("loan_Date")
                .setDataUrl("loan_Date/all")
                .setPostData(new LoanDate())
                .setAddButton(true)
