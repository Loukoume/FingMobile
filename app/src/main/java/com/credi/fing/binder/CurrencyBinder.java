...
import com.credi.fing.entity.Currency;
...
public class CurrencyBinder implements Serializable, BinderInterface {
    @Override
    ...
    public List<Attribut> setAttribut() {
        List<Attribut> attributs = Arrays.asList(
                ...
                new Attribut("Name", "name", true),
                new Attribut("Decimalplaces", "decimalPlaces", true),
                new Attribut("Displaysymbol", "displaySymbol", true),
                new Attribut("Namecode", "nameCode", true),
                new Attribut("Displaylabel", "displayLabel", true)
        );
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(Currency.class)
                .setTitle("Currency".toUpperCase())
                .setEndPointSave("currency")
                .setDataUrl("currency/all")
                .setPostData(new Currency())
                .setAddButton(true)
