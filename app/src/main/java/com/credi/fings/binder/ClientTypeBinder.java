...
import com.credi.fings.entity.ClientType;
...
public class ClientTypeBinder implements Serializable, BinderInterface {
    @Override
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(ClientType.class)
                .setTitle("ClientType".toUpperCase())
                .setEndPointSave("client_type")
                .setDataUrl("client_type/all")
                .setPostData(new ClientType())
                .setAddButton(true)
