...
import com.credi.fings.entity.ClientNonPersonDetails;
...
public class ClientNonPersonDetailsBinder implements Serializable, BinderInterface {
    @Override
...
new Attribut("Constitution","constitution",true),
new Attribut("Mainbusinessline","mainBusinessLine",true)       
 );
 ...
 public EditeObject editeObject() {
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(ClientNonPersonDetails.class)
                .setTitle("ClientNonPersonDetails".toUpperCase())
                .setEndPointSave("client_non_person_details")
                .setDataUrl("client_non_person_details/all")
                .setPostData(new ClientNonPersonDetails())
                .setAddButton(true)
