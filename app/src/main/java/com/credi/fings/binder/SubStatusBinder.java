...
import com.credi.fings.entity.SubStatus;
...
public class SubStatusBinder implements Serializable, BinderInterface {
    @Override
    ...
    public List<Attribut> setAttribut() {
        List<Attribut> attributs = Arrays.asList(
                ...
                new Attribut("None", "none", true),
                new Attribut("Inactive", "inactive", true),
                new Attribut("Dormant", "dormant", true),
                new Attribut("Escheat", "escheat", true),
                new Attribut("Block", "block", true),
                new Attribut("Blockcredit", "blockCredit", true),
                new Attribut("Blockdebit", "blockDebit", true)
        );
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(SubStatus.class)
                .setTitle("SubStatus".toUpperCase())
                .setEndPointSave("sub_status")
                .setDataUrl("sub_status/all")
                .setPostData(new SubStatus())
                .setAddButton(true)
