...
import com.credi.fings.entity.SavingsDate;
...
public class SavingsDateBinder implements Serializable, BinderInterface {
    @Override
    ...
    public List<Attribut> setAttribut() {
        List<Attribut> attributs = Arrays.asList(
                ...
                new Attribut("Activatedondate", "activatedOnDate", true)
        );
    ...
    public NavigateObject navigateObject() {
        NavigateObject navigateObject = new NavigateObject()
                .setBinder(binder())
                .setaClass(SavingsDate.class)
                .setTitle("SavingsDate".toUpperCase())
                .setEndPointSave("savings_Date")
                .setDataUrl("savings_Date/all")
                .setPostData(new SavingsDate())
                .setAddButton(true)
