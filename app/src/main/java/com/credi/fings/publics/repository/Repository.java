package com.credi.fings.publics.repository;
...
import com.credi.fings.publics.repository.sqlite.Attribut;
import com.credi.fings.publics.repository.sqlite.DB;
import com.credi.fings.publics.repository.sqlite.MaBase;
import com.credi.fings.publics.repository.sqlite.Pj;
...
public class Repository{
    ...
    List<com.credi.fings.publics.service.impl.Attribut> coln;
    List<String> columns;
    public Repository(Class<?> t, Context context) {
        ...
        for (com.credi.fings.publics.service.impl.Attribut a:coln) {
    ...
    private void addColonn(String err) {
        ...
        for (com.credi.fings.publics.service.impl.Attribut coln : coln) {
